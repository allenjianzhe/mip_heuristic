...
##                        print i,k,s, GG[i,k,s],'test'
    ...
    #once we got the pi, we need to update upper bound, put here.!!!!
##    print '##################################################################'
##    print 'update upper bound'
##    print '##################################################################'
##    temple_Zub=Updated_UpperBound(X,y,pi,T)
##    
##    print temple_Zub,'temple_Zub','#########################################'
##    Zub=min(temple_Zub,Zub)
