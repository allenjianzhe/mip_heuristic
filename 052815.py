...
print '\n'
print 'Trans_Cost',TransCost1
print '3PL_Cost',threePLCost1
print 'Total_Trans_Cost',TotalTransCost1
print 'Total_Penalty_Cost',TotalTardinessCost1
print 'Total_Cost',TotalCost1
print '\n'                   
####################################################################################################
####################################################################################################
##print arrive_time,'SSSSSSSSSSSSSSSSSSS'
##print arrive_time[0]
from read052815_2 import *
m2 = Model('MIP')
y2={}
for row in customer:
    for i in nodes:
...
print 'Trans_Cost',TransCost1+TransCost2
