#file name netflow061815MIP.py  based on netflow051315MIP.py
import sys
...
print 'Basic info'
for row in customer:
    print 'Customer',int(row[0]),'Destination ',row[1], 'quantity ',int(row[2]),'DD',int(row[3]),'Tardiness',T[int(row[0])].x
print "\n"
