#file name read052415, based on read051315
import csv 
import sys
import math
...
o=open(r'C:\Users\MacBook Air\Desktop\my research\cus_200_2.csv','r')#apple
reader= csv.reader(o)
#header = reader.next()
o.seek(0)
customer=[]
...
trans_time={}
for i in nodes:#when i =3, it is meanless, because we don't want to calculate when i =3
    for k in modes:
        if k==1:
