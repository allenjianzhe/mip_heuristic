#file name read061115_2, based on read052515_2
import csv 
import sys
import math
...
#print 'arc_C',arc_C
o=open(r'C:\Users\MacBook Air\Desktop\my research\cus_4.csv','r')#apple
...
for row in customer:
    if int(row[3])>40:
        DD[int(row[0])]=int(row[3])-13
    if 30<int(row[3])<=40:
        DD[int(row[0])]=int(row[3])-13
    if 20<int(row[3])<=30:
        DD[int(row[0])]=int(row[3])-13
    if 12<int(row[3])<=20:
        DD[int(row[0])]=int(row[3])-5
    if 7<int(row[3])<=12:
        DD[int(row[0])]=int(row[3])-1
    if int(row[3])<=7:
        DD[int(row[0])]=int(row[3])-1
##    else:
##        DD[int(row[0])]=int(row[3])-6
for row in customer:
    print 'row',row,'DD',DD[int(row[0])]
