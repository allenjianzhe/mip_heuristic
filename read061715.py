#file name read061715, based on read061115
import csv 
import sys
import math
...
for row in customer:
    if int(row[3])>40:
        DD[int(row[0])]=int(row[3])-20
    if 30<=int(row[3])<=40:
        DD[int(row[0])]=int(row[3])-20
    if 20<=int(row[3])<30:
        DD[int(row[0])]=int(row[3])-20
    if 12<=int(row[3])<20:
        DD[int(row[0])]=int(row[3])-11
    if 7<int(row[3])<12:
        DD[int(row[0])]=int(row[3])-4
    if int(row[3])<=7:
        DD[int(row[0])]=int(row[3])-4
##    else:
##        DD[int(row[0])]=int(row[3])-12   
##for row in customer:
